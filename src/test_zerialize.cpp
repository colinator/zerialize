...
int main() {
...

    {
        ...
        auto v = zerialize::serialize<zerialize::Flex>();
    ...
    {
        std::cout << "--- 3 ---" << std::endl;
        auto v = zerialize::serialize<zerialize::Flex>(3);
        std::cout << v.to_string() << std::endl;
...

    {
        ...
        auto v = zerialize::serialize<zerialize::Flex>(3, 5.2, "asdf", std::vector<std::any>{7, 8.2});
        std::cout << v.to_string() << std::endl;
...

    {
        ...
        auto v = zerialize::serialize<zerialize::Flex>({ {"a", 3}, {"b", 5.2}, {"c", "asdf"}});
        std::cout << v.to_string() << std::endl;
...

    {
        ...
        auto v = zerialize::serialize<zerialize::Flex, int, double, std::string>({"a", 3}, {"b", 5.2}, {"c", "asdf"});
        std::cout << v.to_string() << std::endl;
        std::cout << v["a"].asInt32() << " " << v["b"].asDouble() << " " << v["c"].asString() << std::endl;
        std::cout << std::endl;
    }

    {
        ...
        auto v = zerialize::serialize<zerialize::Flex, int, double, std::string, std::vector<std::any>>({"a", 3}, {"b", 5.2}, {"c", "asdf"}, {"d", std::vector<std::any>{7, 8.2}});
        std::cout << v.to_string() << std::endl;
...

    {
        ...
        auto v = zerialize::serialize<zerialize::Flex>({{"a", 3}, {"b", 5.2}, {"c", "asdf"}, {"d", std::vector<std::any>{7, 8.2}}});
        std::cout << v.to_string() << std::endl;
        std::cout << v["a"].asInt32() << " " << v["b"].asDouble() << " " << v["c"].asString() << " " << v["d"][0].asInt32() << " " << v["d"][1].asDouble() << std::endl;
        std::cout << std::endl;
    }

    {
        ...
        auto vbuf = v.buf();
        auto vdes = zerialize::Flex::BufferType(vbuf);
        ...
        auto v_span = zerialize::Flex::BufferType(span_view);
        ...
        auto v_move = zerialize::Flex::BufferType(std::move(buf_to_move));
        ...
        auto v_copy = zerialize::Flex::BufferType(v.buf());
